...
const CareSystemPeriodicControlOld2 = () => {
  ...
  return (
    <ScrollView style={{ backgroundColor: "white" }}>
      ...
      />
      {selectedMMSLine?.value && selectedQrCodeZone?.value ? (
        <View
          style={{
            flex: 1,
            flexDirection: "row",
      ...
      {/* {showCamera ? (
        <CareSystemChecklist
          selectedQrCodeZone={selectedQrCodeZone}
          showCamera={showCamera}
        />
      ) : null} */}
      <CareSystemChecklist selectedQrCodeZone={selectedQrCodeZone.value} />
    </ScrollView>
  );
};
...
export default CareSystemPeriodicControlOld2;
