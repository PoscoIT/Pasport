...
const CareSystemMainScreen = () => {
    ...
    return(
        <View style={{flex:1}}>
            ...
            {!scan&&  <View style={{flex:1,flexDirection:"column",alignItems:"center"}}>
                <Button appearance={"outline"} style={styles.button3} onPress={()=>{
                    navigation.navigate("CareSystemPeriodicControl")
                }}>
                    <Text style={styles.buttonTextStyle}>Periyodik Checklist Kontrolü</Text>
                </Button>
                <Button appearance={"outline"} status={"danger"} style={styles.button3} onPress={()=>{
