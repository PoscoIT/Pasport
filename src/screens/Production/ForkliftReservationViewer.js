...
const ForkliftReservationViewer = (props) => {
  const homeOptions = [
    ...
    },
    {
      ...
      description:
        "açıklamaaasaddsadasdasdasdasdasdasdasdasdasdasdasdasdasdsadasddsasadsdadasdasddasdasdsadasdasdasdasdasddsaaçıklamaaasaddsadasdasdasdasdasdasdasdasdasdasdasdasdasdsadasddsasadsdadasdasddasdasdsadasdasdasdasdasddsaaçıklamaaasaddsadasdasdasdasdasdasdasdasdasdasdasdasdasdsadasddsasadsdadasdasddasdasdsadasdasdasdasdasddsa",
      totalTime: "40",
      line: "TLL",
      id: "3",
    },
          ...
          <View style={styles.cardContainer}>
            ...
            <View style={styles.infoStyle}>
              ...
              <Text style={styles.bodyTextStyle}>
                {" "}
                Oluşturan Kişi={props.info.name}
              </Text>
              <Text style={styles.bodyTextStyle}>
                Rezervasyon Tarihi={props.info.body}
              </Text>
              <Text
                ellipsizeMode={"tail"}
                numberOfLines={4}
              ...
              >
                Nedeni= {props.info.description}
              </Text>
              <Text style={styles.bodyTextStyle}>
                Tahmini Süre = {props.info.totalTime}
              </Text>
            </View>
          </View>
        </View>
