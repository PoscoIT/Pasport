...
const CoilCarChecklist = () => {
  ...
  const codeScannner = useCodeScanner({
    ...
    onCodeScanned: (codes) => {
      ...
      setMachineID(
        qrValue.startsWith("coilcar")
          ? Number(qrValue.split("-")[1])
          : Number(qrValue.split("-")[0]),
      );

      const isCoilCar = qrValue.startsWith("coilcar");
                          ...
                          <View>
                            ...
                            >
                              ...
                              <Image
                                ...
                                source={{
                                  uri: `https://tstapp.poscoassan.com.tr:8443/images/ProductionChecklist/CoilCar/${item.ImageUrl}`,
                                }}
                              />
                            </View>
                          </View>
...
export default CoilCarChecklist;
